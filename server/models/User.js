...
const userSchema = new Schema({
  firstName: {
    ...
    maxlength: [15, "First Name can be of maximum 15 characters only."],
  },
  lastName: {
    type: String,
    required: [true, "Last Name is required."],
    minlength: [3, "Last Name should of minimum 3 characters."],
    maxlength: [15, "Last Name can be of maximum 15 characters only."],
  },
  email: {
    type: String,
